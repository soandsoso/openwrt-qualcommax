...
define Device/qihoo_v6
	...
	PAGESIZE := 2048
	DEVICE_DTS_CONFIG := config@cp03-c1
	DEVICE_DTS := ipq6018-qihoo-v6
	SOC := ipq6018
	DEVICE_PACKAGES := ipq-wifi-qihoo_v6 kmod-fs-ext4 mkf2fs f2fsck kmod-fs-f2fs \
		kmod-qca-nss-dp kmod-qca-nss-drv kmod-qca-nss-drv-bridge-mgr kmod-qca-nss-drv-pppoe \
		kmod-qca-nss-drv-vlan-mgr kmod-qca-ssdk qca-ssdk-shell kmod-qca-nss-ecm wpad-openssl
endef
